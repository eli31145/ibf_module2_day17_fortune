package Day17Practice.fortunecookie.services;
...
public class FortuneCookie {
	...
	public static final String[] COOKIES = { "With integrity and consistency -- your credits are piling up.",
		...
		/* public String getCookie(){
			...
			int upperBound = 248;
			int cookieNumber = random.nextInt(upperBound);
			return COOKIES[cookieNumber];
		} */
		
		public String getCookie(){
			Random random = new Random();
			int cookieNumber = random.nextInt(COOKIES.length);
			return COOKIES[cookieNumber];
		}


		//return a number of cookies
/* 		public List<String> getCookies(Integer i){
			Random random = new Random();
			int upperBound = 248;
			int chosenNumber = i;
			...
			for (int k = 0; k<i; k++){
				int cookieNumber = random.nextInt(upperBound);
				cookies.add(COOKIES[cookieNumber]);
			}
		
			return cookies;
		} */

		public List<String> getCookies(Integer num){
			assert (num>0);
			Random random = new Random();
			List<String> cookieList = new LinkedList<>();
			for (Integer i=0; i<num; i++){
				int idx= random.nextInt(COOKIES.length);
				cookieList.add(COOKIES[idx]);
			}
			return cookieList;
		}
